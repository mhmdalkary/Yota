module.exports = {
  config: {
    ...
    longDescription: {
      en: "يضيف هذا الأمر المستخدم إلى مجموعة مجمتمع_البوت التي يريدها المستخدم فقط.",
    },
    category: "المجموعة",
    guide: {
...
api.setMessageReaction("🚫", event.messageID, (err) => {}, true);
      ...
      api.addUserToGroup(userID, supportGroupId, (err) => {
        if (err) {
          console.error("╔═════════ஜ۩۞۩ஜ═════════╗\n\n ❌ |فشلت إضافة مستخدم إلى مجموعة  مجتمع_البوت :\n\n╚═════════ஜ۩۞۩ஜ═════════╝", err);
...
api.setMessageReaction("✅", event.messageID, (err) => {}, true);
          ...
          api.sendMessage(
            "╔═════════ஜ۩۞۩ஜ═════════╗\n\n.✅ |لقد تمت إضافتك إلى مجموعة يوتا البوت . إذا لم تجد الصندوق في صندوق الوارد الخاص بك، فيرجى التحقق من طلبات الرسائل أو صندوق البريد العشوائي.\n\n╚═════════ஜ۩۞۩ஜ═════════╝",
            threadID
          );
        }
      });

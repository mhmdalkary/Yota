...
if (!prompt) {
  await message.reply("📝 | قم بطرح السؤال في الوقت اللتي تحتاجه وساسعى جاهدا للإجابة عنه كما أنه يمكنك إستخدام غني وكتابة اي أغنية تريد سماعها أو أرسم من وكتابة الوصف ليجلب يوتا نايجة كاكتبته أو يوتا أرسل إسم مقطع اللذي تريد مشاهدته.");
  return;
}
...
const a = {
  ...
  countDown: 5,
  role: 0,
  longDescription: "قم بالدردشة مع يوتا",
  category: "الذكاء الإصطناعي",
  guide: {
    en: "{p}يوتا {سؤال او استفسار}"
  }
};
